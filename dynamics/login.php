    ...
    <?php
...

        {
            ...
            switch ($accion){
                ...
                case "Renombrar";
                echo "<form TARGET='_blank' method='post' action='renombrar.php'>";
                    echo "<fieldset>";
                        echo "<legend>Ingresa los siguientes datos para renombrar a tu archivo</legend>";
                        echo"<label>Nombre actual del txt (ruta completa con el .txt):";
                            echo"<input type='text' name='nombreviejo' id='nombreviejo'>";
                        echo"</label>";
                        echo"<br>";
                        echo"<label>Nombre nuevo para el txt(ruta completa con el .txt):";
                            echo"<input type='text' name='nombrenuevo' id='nombrenuevo'>";
                        echo"</label>";
                        echo"<br>";
                        echo"<br>";
                        echo"<label>";
